...
const projects = [
  ...
  { name: 'Proofly',   cat: 'academic', tag: 'Next.js · Express · PostgreSQL',  desc: 'Web app for freelance designers to manage client projects and collect structured visual feedback.', hue: 10,  img: 'assets/pr.jpg' },
  { name: 'Note Taking App',   cat: 'academic', tag: 'MERN Stack',  desc: 'Full-stack notes application with user authentication and CRUD note management.', hue: 10,  img: 'assets/nt.jpg' },
];
